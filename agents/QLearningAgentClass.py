...
class QLearningAgent(Agent):
    ...
    def __init__(self, actions, name="Q-learning", init_q=None, alpha=0.05, gamma=0.99, epsilon=0.1, explore="uniform", anneal=False, default_q=0.0):
        '''
        Args:
    ...
    def end_of_episode(self):
        ...
        '''
        if self.anneal:  # the learning rate and epsilon will be annealed.
            self._anneal()
