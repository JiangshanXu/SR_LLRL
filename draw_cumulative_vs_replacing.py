...
data_dir = ["./results/lifelong-rescue_grid_h-19_w-19sarsa_lambda_SR Cumulative vs sarsa_lambda_SR Replacing-q-learning-vs_task/"]
output_dir = "./plots/"
for index in range(len(data_dir)):
    ...
    # Plot.
    chart_utils.make_plots(data_dir[index], agent_names, cumulative=cumulative, episodic=episodic,
                           track_disc_reward=track_disc_reward, figure_title=mdp_name, plot_file_name=file_name)
