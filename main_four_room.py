...
def main(open_plot=True):
    ...
    if baselines == "q":
        ...
        #                                        name="Sarsa(5)_LLRL")
        #
        # dyna_sr_llrl = DynaLRSQLearningAgent(actions, alpha=lrate, epsilon=eps, gamma=gamma, default_q=vmax, name="dyna_SR_LLRL")
        # # agents
        ...
        # agents = [multi_sr_llrl,Baseline,SR_LLRL,dyna_sr_llrl]
        agents = [multi_sr_llrl,SR_LLRL,dyna_sr_llrl,sarsa_lambda_sr_llrl]
