...
def main(open_plot=True):
    ...
    mdp_distr = make_rescue_grid_world_distribution(obs_num=obstacle_num)
    ...
    if baselines == "q":
        ...
        sarsa_lambda_sr_llrl = SarsaLambdaLRSQLearningAgent(actions, alpha=lrate, epsilon=eps, gamma=gamma, default_q=vmax, name="sarsa_lambda_SR_LLRL")
        sarsa_lambda2_sr_llrl = SarsaLambda2LRSQLearningAgent(actions, alpha=lrate, epsilon=eps, gamma=gamma, default_q=vmax, name="sarsa_lambda2_SR_LLRL")
